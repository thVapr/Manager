...
namespace ManagerData.Migrations
{
    ...
    [Migration("20250606122557_AddHistoryModelToBackgroundTask")]
    partial class AddHistoryModelToBackgroundTask
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ManagerData.DataModels.BackgroundTask", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ManagerData.DataModels.TaskFile", b =>
                {
                    b.Property<Guid>("TaskId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ManagerData.DataModels.TaskMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ManagerData.DataModels.BackgroundTask", b =>
                {
                    b.HasOne("ManagerData.DataModels.TaskHistory", "History")
                        .WithMany()
            ...
            modelBuilder.Entity("ManagerData.DataModels.TaskHistory", b =>
                {
                    ...
                    b.HasOne("ManagerData.DataModels.MemberDataModel", "TargetMember")
                        .WithMany()
            ...
            modelBuilder.Entity("ManagerData.DataModels.TaskMessage", b =>
                {
                    b.HasOne("ManagerData.DataModels.MemberDataModel", "Creator")
                        .WithMany()
